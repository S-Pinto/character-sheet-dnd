document.addEventListener('DOMContentLoaded', () => {
  ...
  let characterData = {
      ...
      skills: { /* Dati non presenti nel PDF, gestiti dalla logica */ },
      proficiencies: {
      ...
      imageUrl: "https://i.pinimg.com/736x/8a/99/a3/8a99a3582f6597370a8b15275e334000.jpg"
  };
  ...
  function renderHeader() {
      ...
      document.getElementById('portrait-container').innerHTML = `
          <div class="view-item"><img id="portrait-img" src="${d.imageUrl}" alt="Ritratto del Personaggio"></div>
          <div class="edit-item">
              <img id="portrait-img-edit" src="${d.imageUrl}" alt="Ritratto del Personaggio">
      ...
      document.getElementById('details-grid').innerHTML = `
          <div class="detail-box">
              <div class="view-item">${d.classLevel}</div><input type="text" class="edit-item" data-path="classLevel" value="${d.classLevel}"><label>Classe & Livello</label>
          </div>
          <div class="detail-box">
              <div class="view-item">${d.race}</div><input type="text" class="edit-item" data-path="race" value="${d.race}"><label>Specie</label>
          </div>
          <div class="detail-box">
              <div class="view-item">${d.background}</div><input type="text" class="edit-item" data-path="background" value="${d.background}"><label>Background</label>
          </div>`;
  }
  ...
  function renderAbilities() {
      ...
      Object.keys(characterData.abilities).forEach(key => {
          ...
          container.innerHTML += `<div class="ability-box">
